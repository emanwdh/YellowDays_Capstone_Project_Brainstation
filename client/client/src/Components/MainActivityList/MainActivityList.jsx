...
export default function MainActivityList( {priority}) {
      ...
      <div className="main-activities">
        ...
        <div className="main-activities__group">
          {activityList.map((activity) => (
            <div key = {activity.activity_id}className="main-activities__activity activity">
              <div className="activity__main-group">
                ...
                <div className="activity__free-tag">{activity.free === 1? "FREE" :""}</div>
              </div>
              <div className="activity__additional-group">
                <p className="activity__timestamp">{relativeDate(activity.created_at)}</p>
                <h3 className="activity__interest-category">{activity.interest}</h3>
